...
| Command | Purpose |
| --- | --- |
| `doctor [--capture] [--connection <name>]` | Diagnose package/protocol versions, selected installation scope and path, duplicate project/global copies, bundled core readiness, optional capture dependencies, and optionally the paired server version. It does not acquire a work lease. |
