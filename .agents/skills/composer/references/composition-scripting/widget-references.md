...
The script handoff and composition-script helper summaries expose `widgetReferences`, a compact list of the widget IDs and loaded versions observed in their scope. Each entry has this shape:
